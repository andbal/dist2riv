...
#setwd("H:/Projekte/MONALISA/12_GIS/Workspace/BrJ/01_Influence_Analysis")
source("H:/Projekte/MONALISA/12_GIS/Workspace/BrJ/01_Influence_Analysis/dist2riv.R")

### read dem
dem <- raster("H:/Projekte/MONALISA/12_GIS/Workspace/BrJ/01_Influence_Analysis/clip/DEM_clip1.tif")
#dem_clip <- raster("H:/Projekte/MONALISA/12_GIS/Workspace/LaD/03_Influence_Analysis/dtm_2pt5m.tif")
#plot(dem)

### read river tif
adige <- raster("H:/Projekte/MONALISA/12_GIS/Workspace/BrJ/01_Influence_Analysis/clip/Adige_clip1.tif")
#adige_clip <- raster("H:/Projekte/MONALISA/12_GIS/Workspace/LaD/03_Influence_Analysis/Adige.tif")
